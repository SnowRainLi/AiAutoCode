...
import org.czjtu.aiautocode.ai.guardrail.PromptSafetyInputGuardrail;
import org.czjtu.aiautocode.ai.tools.ToolManager;
        ...
        return switch (codeGenType) {
            case VUE_PROJECT -> {
                ...
                yield AiServices.builder(AICodeGeneratorService.class)
                        ...
                        .maxSequentialToolsInvocations(20)//允许最多20次工具调用
                        .inputGuardrails(new PromptSafetyInputGuardrail())//添加输入护轨
//                        .outputGuardrails(new RetryOutputGuardrail())//添加输出护轨,流式输出情况下可能会影响流式输出的效果
                        .build();
            }
